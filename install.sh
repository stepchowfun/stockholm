...
(
  ...
  if [ -n "${VERSION:-}" ]; then
    DOWNLOAD_URL="https://github.com/stepchowfun/stockholm/releases/download/v$VERSION/$FILENAME"
  else
    DOWNLOAD_URL="https://github.com/stepchowfun/stockholm/releases/latest/download/$FILENAME"
  fi
