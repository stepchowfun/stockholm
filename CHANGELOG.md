...
### Changed
- Lead each open-order status entry with its side.

## [0.2.49] - 2026-08-18

### Changed
- Include open-order details in the live control-loop status log.

## [0.2.48] - 2026-08-17

### Changed
- Tune live market-making to a 1% buy discount, 0.5% sell markup, 5-second buy lifetime, and 120-second sell lifetime.

## [0.2.47] - 2026-08-11

### Changed
- Include individual daily returns in market-maker backtest reports.
