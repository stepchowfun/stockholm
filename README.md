...
Stockholm is an algorithmic trading bot written in Rust.

The project is currently an early-stage scaffold. Trading strategies, market-data integrations,
broker integrations, risk controls, and order execution are not implemented yet.
