...
The live strategy runs its control loop once per second. Between 3:45 p.m. and 8 p.m. Eastern time, it suppresses ordinary market-making orders, immediately cancels its buy orders for the selected symbol, gives matching sell orders a 10-second lifetime, and repeatedly offers every unreserved whole share at the current ask. Stockholm-managed orders for other symbols and orders placed outside Stockholm are unaffected.
